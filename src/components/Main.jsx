...
const Main = () => {
    ...
    return (
        <main className="bg-white rounded-100 -mt-24">
            <div className="max-w-5xl mx-auto px-5">
                ...
                <div className="flex flex-row items-center justify-between py-11">
                    <div className="flex items-center flex-row space-x-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="block text-xl leading-8 ml-2">
                                    2435 supporters
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center space-x-4">
                        <a href="!#" className="w-40 block bg-brand-violet text-xl font-medium border border-black leading-8 rounded-full px-6 py-3 mt-4">
                            <div className="flex items-center">
                                <img src="images/donate.svg" alt="donation mag" className="mr-4" />
                                Donate
                            </div>
                        </a>

                        <a href="!#" className="w-40 block text-center bg-white text-xl font-medium border border-black leading-8 rounded-full px-6 py-3 mt-4">
                            Follow
                        </a>
                    </div>
                </div>
